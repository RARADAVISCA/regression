...
suppressPackageStartupMessages({
 library(ggplot2)                     # Untuk membuat grafik visualisasi
  library(corrplot)                   # Untuk membuat heatmap korelasi
  library(readr)                      # Untuk membaca file CSV dengan read_csv()
  library(dplyr)                      # Untuk manipulasi data (seperti select, filter, dll.)
})
